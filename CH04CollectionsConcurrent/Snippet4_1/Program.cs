...
// The code generates undpredictable results
// The code is intended to show an example of problems
// related to concurrency
namespace Snippet4_1
{
    class Program
    {
        ...
        private static void ParallelPartitionGenerateAESKeys()
        {
            ...
            Parallel.ForEach(Partitioner.Create(1, NUM_AES_KEYS + 1), range =>
            {
                ...
                for (int i = range.Item1; i < range.Item2; i++)
                {
                    ...
                    // The following code will generate undpredictable results
                    // It is unsafe to add elements to the List
