    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var t1 = Task.Factory.StartNew(
                () => GenerateAESKeysCancel(ct), ct);
            var t2 = Task.Factory.StartNew(
                () => GenerateMD5HashesCancel(ct), ct);
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "GenerateAESKeys and GenerateMD5Hashes are taking more than 1 second to complete.");
            ...
            {
                Console.WriteLine(
                    "The task running GenerateAESKeysCancel was cancelled.");
            }
            if (t2.IsCanceled)
            {
                Console.WriteLine(
                    "The task running GenerateMD5HashesCancel was cancelled.");
            }
            if (t1.IsFaulted)
            {
