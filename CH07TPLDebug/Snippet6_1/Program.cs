...
namespace Snippet6_1
{
    class Program
    {
        ...
        private static void ParGenAES(System.Threading.CancellationToken ct, char prefix)
        {
        ...
        private static int CountLetters(String key)
        {
            int letters = 0;
        ...
        static void Main(string[] args)
        {
            ...
            var tAsync = new Task(() => ParGenAES(ct, 'A'));
            ...
            var keysWith10Letters = from key in _keysQueue.AsParallel()
