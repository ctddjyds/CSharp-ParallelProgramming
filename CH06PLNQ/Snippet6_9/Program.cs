...
namespace Snippet6_9
{
    class Program
    {
        ...
        // Environment.ProcessorCount requires a Platform Invoke (P/Invoke)
        // This variable caches its value
        // However, the number of logical cores might change in some specific hardware
        ...
        {
            //ct.ThrowIfCancellationRequested();
            return inputIntegers.AsParallel().WithCancellation(ct)
             .WithDegreeOfParallelism(processorCount / 2)
             .Aggregate(
                // Seed
             0d,
                // Update accumulator function
